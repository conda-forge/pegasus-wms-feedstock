...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pegasus-wms-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11459&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pegasus-wms-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pegasus-wms, python-pegasus-wms` can be installed with:

```
conda install pegasus-wms python-pegasus-wms
```

It is possible to list all of the versions of `pegasus-wms` available on your platform with:
